...
bool ConfigStore::loadFermentationConfig(FermentationConfig& config) {
    ...
    config.alarms.deviationC = prefs.getFloat("fcfg_devc", config.alarms.deviationC);
    config.alarms.sensorStaleSeconds =
        prefs.getUInt("fcfg_stale", config.alarms.sensorStaleSeconds);
...
bool ConfigStore::saveFermentationConfig(const FermentationConfig& config) {
    ...
    prefs.putFloat("fcfg_devc", config.alarms.deviationC);
    prefs.putUInt("fcfg_stale", config.alarms.sensorStaleSeconds);

...
def _apply_bootstrap_migrations() -> None:
    with engine.begin() as connection:
        ...
        for statement in (
            ...
            "ALTER TABLE device_telemetry ADD COLUMN IF NOT EXISTS effective_target_c DOUBLE PRECISION",
            "ALTER TABLE device_telemetry ADD COLUMN IF NOT EXISTS profile_step_id VARCHAR(64)",
            ...
            "ALTER TABLE device_output_assignments ADD COLUMN IF NOT EXISTS switch_id INTEGER DEFAULT 0",
            "ALTER TABLE discovered_relays ADD COLUMN IF NOT EXISTS switch_id INTEGER DEFAULT 0",
        ):
